...
export declare class DeviceMethod {
     ...
     */
    invokeOn(deviceId: string, done?: TripleValueCallback<any, any>): Promise<{
        device?: any;
        response?: any;
    }> | void;
    /**
     ...
     * @returns {Promise<{ device?: any, response?: any }> | void} Promise if no callback function was passed, void otherwise.
     */
    invokeOnModule(deviceId: string, moduleId: string, done?: TripleValueCallback<any, any>): Promise<{
        device?: any;
        response?: any;
    }> | void;
}
