...
var Registry = /** @class */ (function () {
    ...
    Registry.prototype.updateConfiguration = function (configuration, forceUpdateOrDone, done) {
        var _this = this;
        var callback = done || (forceUpdateOrDone instanceof Function ? forceUpdateOrDone : undefined);
        if (callback) {
    ...
    Registry.prototype.removeModule = function (moduleOrDeviceId, doneOrModuleId, done) {
        var _this = this;
        var callback = done || (doneOrModuleId instanceof Function ? doneOrModuleId : undefined);
        if (callback) {
